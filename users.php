...
<div class="header">
    ...
    <div class="header-right">
        <a href="pages/profiles.php">My Profile</a>
...
<div class="users-section">
    ...
    <?php if (count($pending_requests) > 0): ?>
        ...
        <?php foreach ($pending_requests as $req): ?>
            <div class="user">
                <div class="user-info">
                    <a href="pages/profiles.php?user_id=<?php echo $req['user_id']; ?>" class="user-name">
    ...
    <?php if (count($friend_ids) > 0): ?>
        ...
        ?>
            <div class="user">
                <div class="user-info">
                    <a href="pages/profiles.php?user_id=<?php echo $u['user_id']; ?>" class="user-name">
                ...
                <div class="user-actions">
                    <a href="pages/chat.php?user_id=<?php echo $u['user_id']; ?>" class="btn btn-chat">Chat</a>
                    <a href="pages/profiles.php?user_id=<?php echo $u['user_id']; ?>" class="btn btn-profile">View</a>
                </div>
            </div>
        <?php endwhile; ?>
    <?php endif; ?>
...
function acceptRequest(requestId, button) {
    fetch('actions/handle_friend_request.php', {
        method: 'POST',
        headers: {'Content-Type': 'application/x-www-form-urlencoded'},
